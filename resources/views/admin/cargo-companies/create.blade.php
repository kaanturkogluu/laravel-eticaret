...
@section('title', 'Yeni Kargo Şirketi')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Yeni Kargo Şirketi Ekle</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.cargo-companies.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tracking_url" class="form-label">Takip URL</label>
                                    <input type="text" class="form-control @error('tracking_url') is-invalid @enderror" 
                                           id="tracking_url" name="tracking_url" value="{{ old('tracking_url') }}"
                                           placeholder="https://example.com/track?code={tracking_number}">
                                    @error('tracking_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.cargo-companies.index') }}" class="btn btn-secondary">
