...
@section('title', 'Kupon Düzenle - Basital.com')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Kupon Bilgileri</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.coupons.update', $coupon) }}" id="couponForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                       name="code" value="{{ old('code', $coupon->code) }}" required maxlength="50">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   name="name" value="{{ old('name', $coupon->name) }}" required maxlength="255">
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror" name="type" id="discountType" required>
                                ...
                                <option value="fixed_amount" {{ old('type', $coupon->type) == 'fixed_amount' ? 'selected' : '' }}>Sabit Tutar (TL)</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text" id="valueUnit">{{ $coupon->type === 'percentage' ? '%' : 'TL' }}</span>
                            </div>
                            @error('value')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('usage_limit_per_user') is-invalid @enderror" 
                                   name="usage_limit_per_user" value="{{ old('usage_limit_per_user', $coupon->usage_limit_per_user) }}" min="1">
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="free_shipping" value="1" 
                                       id="freeShipping" {{ old('free_shipping', $coupon->free_shipping) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="is_active" value="1" 
                                       id="isActive" {{ old('is_active', $coupon->is_active) ? 'checked' : '' }}>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-chart-bar me-2"></i>Kupon İstatistikleri</h5>
            </div>
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-6 mb-3">
                        <div class="border rounded p-3">
                            <h4 class="text-primary mb-1">{{ $coupon->used_count }}</h4>
                            <small class="text-muted">Kullanım Sayısı</small>
                        </div>
                    </div>
                    <div class="col-6 mb-3">
                        <div class="border rounded p-3">
                            <h4 class="text-success mb-1">{{ $coupon->remaining_usage ?? '∞' }}</h4>
                            <small class="text-muted">Kalan Kullanım</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><strong>Oluşturulma:</strong> {{ $coupon->created_at->format('d.m.Y H:i') }}</li>
                        <li><strong>Son Güncelleme:</strong> {{ $coupon->updated_at->format('d.m.Y H:i') }}</li>
                    </ul>
                </div>

                <div class="mt-3">
                    <a href="{{ route('admin.coupons.usage-history', $coupon) }}" class="btn btn-outline-info btn-sm w-100">
...
$(document).ready(function() {
    ...
    $('#couponForm').on('submit', function(e) {
        ...
        $submitBtn.prop('disabled', true).html('<i class="fas fa-spinner fa-spin me-2"></i>Güncelleniyor...');
    });
